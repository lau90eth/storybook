...
import {
  versions_default
} from "./chunk-4ROB3WCB.js";
import {
  require_picomatch
} from "./chunk-RGS3LXAW.js";
import {
  logger
} from "./chunk-QTUMNOBG.js";
import {
  any,
  from,
  invariant,
...
import {
  ...
  resolvePackageDir,
  safeResolveModule
} from "./chunk-GKZHMXCG.js";
import {
  join,
  parse,
  resolve
} from "./chunk-U255RR5H.js";
import {
  glob,
  globSync
} from "./chunk-OUCADXTV.js";
import {
  slash
} from "./chunk-HLP3H23G.js";
import {
  require_dist
} from "./chunk-ZYCQYU5P.js";
import {
  require_picocolors
} from "./chunk-HIQU6BTN.js";
import {
  __commonJS,
  __esm,
  __export,
...
async function loadEnvs(options = {}) {
  let { getEnvironment } = await import("./lib-IAG3XT2U.js"), defaultNodeEnv = options.production ? "production" : "development", env2 = {
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-DJRLVC5S.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-5RGYVFOA.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
