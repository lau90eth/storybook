...
`, NextButton = styled(Button)(({ theme: theme22 }) => ({
  ...
  // node_modules/@storybook/addon-onboarding/dist/manager.js
  var Onboarding2 = lazy(() => Promise.resolve().then(() => (init_Onboarding_4UKVZPT6(), Onboarding_4UKVZPT6_exports))), Survey2 = lazy(() => Promise.resolve().then(() => (init_Survey_RTIK67MQ(), Survey_RTIK67MQ_exports))), root2 = null, render2 = (node) => {
