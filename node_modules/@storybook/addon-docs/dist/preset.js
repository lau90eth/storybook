import CJS_COMPAT_NODE_URL_ayardfyh8y8 from 'node:url';
import CJS_COMPAT_NODE_PATH_ayardfyh8y8 from 'node:path';
import CJS_COMPAT_NODE_MODULE_ayardfyh8y8 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_ayardfyh8y8.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_ayardfyh8y8.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_ayardfyh8y8.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-264YL4LW.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-5QKYFRLC.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-B2F256JN.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-H6V4Z4QR.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
