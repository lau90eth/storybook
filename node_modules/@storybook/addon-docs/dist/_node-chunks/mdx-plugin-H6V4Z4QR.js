...
import {
  compile
} from "./chunk-FUR3XQBF.js";
import "./chunk-5LFNZ4HD.js";
import "./chunk-ZPBKCFOC.js";
import {
  __commonJS,
  __toESM
} from "./chunk-264YL4LW.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-5QKYFRLC.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-B2F256JN.js")).default;
  return {
